...
namespace RazerFinal.Migrations
{
    ...
    [Migration("20230521064219_UpdatedIdexPostTable")]
    partial class UpdatedIdexPostTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RazerFinal.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RazerFinal.Models.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RazerFinal.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RazerFinal.Models.CategorySpec", b =>
                {
                    b.HasOne("RazerFinal.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("RazerFinal.Models.Comment", b =>
                {
                    b.HasOne("RazerFinal.Models.Blog", "Blog")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("RazerFinal.Models.OrderItem", b =>
                {
                    b.HasOne("RazerFinal.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("RazerFinal.Models.ProductSpec", b =>
                {
                    b.HasOne("RazerFinal.Models.CategorySpec", "CategorySpec")
                        .WithMany()
                    ...
                    b.HasOne("RazerFinal.Models.Specification", "Specification")
